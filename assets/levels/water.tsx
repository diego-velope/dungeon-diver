...
<tileset version="1.10" tiledversion="1.12.1" name="water" tilewidth="16" tileheight="16" tilecount="16" columns="8">
 <image source="../tileset/decoration/Water.png" width="128" height="32"/>
 <tile id="0">
  <animation>
