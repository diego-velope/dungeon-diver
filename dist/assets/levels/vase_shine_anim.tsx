...
<tileset version="1.10" tiledversion="1.12.1" name="vase_shine_anim" tilewidth="16" tileheight="16" tilecount="16" columns="16">
 <image source="../tileset/decoration/vase_shine_anim.png" width="256" height="16"/>
 <tile id="0">
  <animation>
