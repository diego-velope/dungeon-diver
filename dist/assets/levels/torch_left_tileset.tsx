...
<tileset version="1.10" tiledversion="1.12.1" name="torch_left_tileset" tilewidth="16" tileheight="16" tilecount="8" columns="8">
 <image source="../tileset/decoration/torch_left.png" width="128" height="16"/>
 <tile id="0">
  <animation>
